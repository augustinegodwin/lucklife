...
export default function ProductCard({ product }: { product: Product }) {
  return (
    ...
    >
      <div className="p-7.5 flex flex-col h-full">
        <div className="flex flex-1 w-full flex-col md:flex-row items-center">
          <div className="flex-1 flex w-full items-center justify-center size-full">
